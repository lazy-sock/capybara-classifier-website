...
const Dropdown: React.FC<DropdownProps> = ({ options, label, onSelect }: DropdownProps) => {
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className=" absolute mt-2 mr-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none ">
          <div className="py-1">
            {options.map((option) => (
              <button
                key={option}
